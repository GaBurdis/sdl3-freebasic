...
If Not SDL_Init(SDL_INIT_VIDEO) Then
    ...
    quit = True
ElseIf Not SDL_CreateWindowAndRenderer("Example Renderer Rotating Textures", WINDOW_WIDTH, WINDOW_HEIGHT, 0, @win, @renderer) Then
...
While Not quit
    ...
    Dim As Single rotation = (CSng(now Mod 2000) / 2000.0) * 360.0
